...
function nan(d) {
  return {
    'category': parseNA(d['Type']), // 將屬性 category 的值進行 parseNA 轉換
    'name': parseNA(d['Company Name']), // 將屬性 name 的值進行 parseNA 轉換
    'value': parseNA(d['2020_revenue']), // 將屬性 value 的值進行 parseNA 轉換
  };
}
