...
export default function barpage(specificIndustry) {
  ...
  function nan(d) {
    return {
      '行業': parseNA(d['行業']), // 将属性 '行業' 的值进行 parseNA 转换
      '公司': parseNA(d['公司']), // 将属性 '公司' 的值进行 parseNA 转换
      '2020營收': parseNA(d['2020_營收']), // 将属性 '2020_營收' 的值进行 parseNA 转换
      '2020淨利': parseNA(d['2020_淨利']), // 将属性 '2020_淨利' 的值进行 parseNA 转换
      '2020資本支出': parseNA(d['2020_資本支出']), // 将属性 '2020_資本支出' 的值进行 parseNA 转换
      '2021營收': parseNA(d['2021_營收']), // 将属性 '2021_營收' 的值进行 parseNA 转换
      '2021淨利': parseNA(d['2021_淨利']), // 将属性 '2021_淨利' 的值进行 parseNA 转换
      '2021資本支出': parseNA(d['2021_資本支出']), // 将属性 '2021_資本支出' 的值进行 parseNA 转换
    };
  }
